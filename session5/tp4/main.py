...
### GOAL : complete this file (main_students.py) in order to perform the full training and testing procedure using reinforcement learning and experience replay.
...
### - an experience is a set of movements of the agent that we store for later
...
### For the NLinearModels class, you should check the train_on_batch method for training, and the predict method for inference (to predict the next action given a state)
